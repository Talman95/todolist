...
export const addTask = createAsyncThunk<TaskType, { todoId: string, title: string }, ThunkErrorType>('tasks/addTask',
...
export const updateTask = createAsyncThunk<{ todoId: string, taskId: string, model: UpdateModelType },
